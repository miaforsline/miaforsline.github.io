...
```{r}
joined <- rbind(c4_clean, c3_clean, c2_clean, c1_clean) %>% 
...
```{r}
a <- ggplot(data = c1_clean, aes(x = PM2.5)) +
  geom_histogram() + 
  theme_classic() + 
  labs(x = "2013 mean concentration of PM2.5 ",
       y = "Frequency")

b <- ggplot(data = c2_clean, aes(x = PM2.5)) +
  geom_histogram() + 
  theme_classic() + 
  labs(x = "2014 mean concentration of PM2.5 ",
       y = "Frequency")

c <- ggplot(data = c3_clean, aes(x = PM2.5)) +
  geom_histogram() + 
  theme_classic() + 
  labs(x = "2018 mean concentration of PM2.5 ",
       y = "Frequency")

d <- ggplot(data = c4_clean, aes(x = PM2.5)) +
  geom_histogram() + 
  theme_classic() + 
  labs(x = "2021 mean concentration of PM2.5 ",
       y = "Frequency")
