...
sub_c4 <- subset(joined, Year == "2021")
sub_c3 <- subset(joined, Year == "2018")
sub_c2 <- subset(joined, Year == "2014")
sub_c1 <- subset(joined, Year == "2013")

# ggplot(data = sub_c4, aes(x = Poverty, y = PM2.5)) +
...
#   labs(x = "% of population per census tract living below two times the federal poverty level", 
#        y = expression(paste
#                       ("Annual mean concentration of PM2.5 per census tract (µg/m"^3~")")
#                       )
#        )
```
