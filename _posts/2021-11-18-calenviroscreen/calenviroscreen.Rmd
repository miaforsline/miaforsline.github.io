...
The quarterly estimates were then averaged to calculate annual means (Figure \@ref(fig:pm)). The annual means were estimated over 3 years to avoid account for uneven sampling frequency.
