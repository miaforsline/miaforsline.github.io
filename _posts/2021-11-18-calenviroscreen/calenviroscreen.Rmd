...
```{r pm, fig.cap = '2013 - 2021 mean PM2.5 in California was not normally distributed. In 2013, 2014, 2018, and 2021, the annual mean concentrations of PM2.5 (µg/m3) per census tract were 11.52, 10.01, 10.38, and 10.15 respectively. Data was sourced from CalEnviroScreen 1.1 - 4.0 (https://oehha.ca.gov/).'}
...
For all time periods, annual mean PM2.5 concentrations were significantly influenced by the percent of people living below twice the federal poverty level. In 2013, PM2.5 increased by 0.035 µg/m3 as the poverty rate increased by 1% (p-value \< 0.001, sd = `r sum1$coefficients[4]`). In 2014, PM2.5 increased by 0.028 µg/m3 as the poverty rate increased by 1% (p-value \< 0.001, sd = `r sum2$coefficients[4]`). In 2018, PM2.5 increased by 0.030 µg/m3 as the poverty rate increased by 1% (p-value \< 0.001, sd = `r sum3$coefficients[4]`). In 2021, PM2.5 increased by 0.029 µg/m3 as the poverty rate increased by 1% (p-value \< 0.001, sd = `r sum4$coefficients[4]`). These results support my hypothesis that mean PM2.5 and poverty in California are significantly related (Figure \@ref(fig:final)). More specifically, over time, the relationship between mean PM2.5 and poverty rate has slightly changed but remained fairly similar.

```{r final, fig.cap = 'Air quality significantly associates poverty in California. For each sampled time period, as poverty rates increase in California, mean PM2.5 increases and air quality deteriorates (p-value <<< 0.001).'}
joined <- joined %>% 
